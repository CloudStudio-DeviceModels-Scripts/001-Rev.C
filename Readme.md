...
# Parsing + Configuration Script – 001 - Rev. C

This **Parsing + Configuration** script is designed for the **001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – 001 Rev. C

Este script de **Parsing + Configuration** está diseñado para el modelo **001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
